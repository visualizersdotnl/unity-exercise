...
#	g++ -o boggle test.cpp solver.cpp random.cpp tlsf/tlsf.c -std=c++20 -O3 -DNDEBUG -fno-exceptions -Wall
	clang++ -o boggle test.cpp solver.cpp random.cpp tlsf/tlsf.c -std=c++20 -O3 -DNDEBUG -fno-exceptions -Wall
	clang++ -o boggle_sub test.cpp solver_submitted.cpp random.cpp -std=c++20 -O3 -fno-exceptions -DNDEBUG
